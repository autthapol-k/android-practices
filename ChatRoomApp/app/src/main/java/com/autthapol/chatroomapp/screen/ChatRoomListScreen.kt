...
import com.autthapol.chatroomapp.viewmodel.RoomViewModel
...
fun ChatRoomListScreen(roomViewModel: RoomViewModel = viewModel(), onJoinClicked: (Room) -> Unit) {
    ...
    Column(
        ...
        Text(text = "Chat Room", fontSize = 20.sp, fontWeight = FontWeight.Bold)
...
@Preview
@Composable
private fun ChatRoomListPreview() {
    ChatRoomListScreen {
    }
}
