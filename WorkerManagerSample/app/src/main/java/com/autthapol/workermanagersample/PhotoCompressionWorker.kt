package com.autthapol.workermanagersample
...
class PhotoCompressionWorker(
    ...
    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO) {
            ...
            val compressThresholdInBytes = params.inputData.getLong(
            ...
            } while (outputBytes.size > compressThresholdInBytes && quality > 5)
